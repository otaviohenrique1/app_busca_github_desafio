...
interface RepositoryTable3Props {
  data: Repository[];
  github_username: string;
}

export function RepositoryTable3(props: RepositoryTable3Props) {
                ...
                {row.getVisibleCells().map(cell => (
                  ...
                  onClick={() => {
                    MySwal.fire({
                      title: <div>
                        <ul>
                          <li>{Object.keys(app_typescript_teste_language_list).toString()}</li>
                        </ul>
                      </div>,
                    })
                  }}
